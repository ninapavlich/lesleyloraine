...
from lesleyloraine.apps.page.sitemap import *
...
urlpatterns +=  patterns('',
    ...
    # -- lesleyloraine URLS
    url(r'^', include('lesleyloraine.apps.media.urls')),
    url(r'^', include('lesleyloraine.apps.form.urls')),
    url(r'^', include('lesleyloraine.apps.email.urls')),
    url(r'^', include('lesleyloraine.apps.page.urls')),
