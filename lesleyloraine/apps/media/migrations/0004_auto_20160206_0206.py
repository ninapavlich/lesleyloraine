...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0003_auto_20160205_2337'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('media', '0003_auto_20160205_2337'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='image',
            field=models.ForeignKey(related_name='media_mediafolder_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Featured image', null=True),
        ),
        migrations.AddField(
            model_name='mediafolder',
            name='modified_by',
            field=models.ForeignKey(related_name='media_mediafolder_modified_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='mediafolder',
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.MediaFolder', null=True),
        ),
        migrations.AddField(
            model_name='mediafolder',
            name='published_by',
            field=models.ForeignKey(related_name='media_mediafolder_published_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='mediafolder',
            name='social_share_image',
            field=models.ForeignKey(related_name='media_mediafolder_social_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Standards for the social share image vary, but an image at least 300x200px should work well.', null=True),
        ),
        migrations.AddField(
            model_name='mediafolder',
            name='template',
        ...
        migrations.AddField(
            ...
            name='image',
            field=models.ForeignKey(related_name='media_imagefolder_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Featured image', null=True),
        ),
        migrations.AddField(
            model_name='imagefolder',
            name='modified_by',
            field=models.ForeignKey(related_name='media_imagefolder_modified_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='imagefolder',
            name='parent',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.ImageFolder', null=True),
        ),
        migrations.AddField(
            model_name='imagefolder',
            name='published_by',
            field=models.ForeignKey(related_name='media_imagefolder_published_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='imagefolder',
            name='social_share_image',
            field=models.ForeignKey(related_name='media_imagefolder_social_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Standards for the social share image vary, but an image at least 300x200px should work well.', null=True),
        ),
        migrations.AddField(
            model_name='imagefolder',
            name='template',
